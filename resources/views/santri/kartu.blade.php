...
<head>
    ...
    <title>Kartu Santri {{ $santri->nis }}</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .toolbar { max-width: 92mm; margin: 0 auto 16px; text-align: center; }
        .toolbar button {
        ...
        .kartu-label {
            font-size: 10px; letter-spacing: 3px; opacity: .85; font-weight: 600; margin-top: 2px;
        }
        ...
        @media print {
            ...
            .kartu-santri { box-shadow: none; margin: 0; page-break-inside: avoid; }
            @page { size: 100mm 65mm; margin: 2mm; }
        }
    </style>
</head>
<body>
    <div class="toolbar">
        <button onclick="window.print()"><i class="fas fa-print"></i> Cetak Kartu</button>
    </div>
